...
let grupoA = [ 
    {nome: 'Argentina', jogos:3, pontos: [], pontuacao_final:0, gols: arr0, gp: [], gc: [], saldo: 0, cartoes:cards0, soma_gols: 0, soma_cartoes: 0, soma_gc: 0, v: 0, e: 0, d: 0}, 
    {nome: 'Arabia Saudita', jogos:3, pontos: [], pontuacao_final:0, gols: arr1, gp: [], gc: [], saldo: 0, cartoes:cards1, soma_gols: 0, soma_cartoes: 0,soma_gc: 0, v: 0, e: 0, d: 0}, 
    {nome: 'México', jogos:3, pontos: [], pontuacao_final:0, gols: arr2, gp: [], gc: [], saldo: 0, cartoes:cards2, soma_gols: 0, soma_cartoes: 0,soma_gc: 0, v: 0, e: 0, d: 0}, 
    {nome: 'Polonia', jogos:3, pontos: [], pontuacao_final:0, gols: arr3, gp: [], gc: [], saldo: 0, cartoes:cards3, soma_gols: 0, soma_cartoes: 0,soma_gc: 0, v: 0, e: 0, d: 0}, 
] 
...
let classificacaoC = _.orderBy(grupoA, ['pontuacao_final', 'v', 'saldo', 'gp', 'e', 'soma_cartoes'], ['desc', 'desc', 'desc', 'desc', 'desc', 'asc'])

// console.log(classificacaoC, "TIMES CLASSIFICADOS")

// let match = grupoA[0].nome + " " + grupoA[0].gols[0] + " x " + grupoA[1].gols[0]  + " " + grupoA[1].nome

// console.log(match)

const c1 = classificacaoC[0]
const c2 = classificacaoC[1]

module.exports = {c1, c2, classificacaoC}
