...
let grupoA = [ 
    {nome: 'Catar', jogos:3, pontos: [], pontuacao_final:0, gols: arr0, gp: [], gc: [], saldo: 0, cartoes:cards0, soma_gols: 0, soma_cartoes: 0, soma_gc: 0, v: 0, e: 0, d: 0}, 
    {nome: 'Equador', jogos:3, pontos: [], pontuacao_final:0, gols: arr1, gp: [], gc: [], saldo: 0, cartoes:cards1, soma_gols: 0, soma_cartoes: 0,soma_gc: 0, v: 0, e: 0, d: 0}, 
    {nome: 'Holanda', jogos:3, pontos: [], pontuacao_final:0, gols: arr2, gp: [], gc: [], saldo: 0, cartoes:cards2, soma_gols: 0, soma_cartoes: 0,soma_gc: 0, v: 0, e: 0, d: 0}, 
    {nome: 'Senegal', jogos:3, pontos: [], pontuacao_final:0, gols: arr3, gp: [], gc: [], saldo: 0, cartoes:cards3, soma_gols: 0, soma_cartoes: 0,soma_gc: 0, v: 0, e: 0, d: 0}, 
] 
...
let classificacaoA = _.orderBy(grupoA, ['pontuacao_final', 'v', 'saldo', 'gp', 'e', 'soma_cartoes'], ['desc', 'desc', 'desc', 'desc', 'desc', 'asc'])

// console.log(classificacaoA, "TIMES CLASSIFICADOS")

// let match = grupoA[0].nome + " " + grupoA[0].gols[0] + " x " + grupoA[1].gols[0]  + " " + grupoA[1].nome

// console.log(match)

const a1 = classificacaoA[0]
const a2 = classificacaoA[1]

module.exports = { a1, a2, classificacaoA}
